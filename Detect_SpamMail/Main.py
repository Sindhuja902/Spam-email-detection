...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(975, 585)
        Dialog.setStyleSheet("background-color: rgb(200, 118, 97);")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(30, 20, 981, 111))
        self.label.setStyleSheet("font: 75 18pt \"Tahoma\";\n"
"font: 20pt \"Franklin Gothic Demi\";")
        self.label.setObjectName("label")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(40, 180, 251, 241))
        self.label_3.setStyleSheet("image: url(../Detect_SpamMail/images/spam.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "EMAIL SPAM DETECTION USING PYTHON & MACHINE LEARNING"))
